...
// */ #define MBEDTLS_MPI_MAX_SIZE            1024 /**< Maximum number of bytes
// for usable MPIs. */
...
#define MBEDTLS_CTR_DRBG_RESEED_INTERVAL                                       \
  0xFFF0 /**< Interval before reseed is performed by default */
// #define MBEDTLS_CTR_DRBG_MAX_INPUT                256 /**< Maximum number of
// additional input bytes */ #define MBEDTLS_CTR_DRBG_MAX_REQUEST 1024 /**<
// Maximum number of requested bytes per call */ #define
// MBEDTLS_CTR_DRBG_MAX_SEED_INPUT           384 /**< Maximum size of (re)seed
// buffer */
#define MBEDTLS_CTR_DRBG_USE_128_BIT_KEY /**< Use 128-bit key for CTR_DRBG -   \
                                            may reduce security (see           \
                                            ctr_drbg.h) */
/* HMAC_DRBG options */
...
// sources supported */ #define MBEDTLS_ENTROPY_MAX_GATHER                144
...
#define MBEDTLS_PLATFORM_STD_MEM_HDR                                           \
  <stdlib.h> /**< Header to include if MBEDTLS_PLATFORM_NO_STD_FUNCTIONS is    \
                defined. Don't define if no header is needed. */
#define MBEDTLS_PLATFORM_STD_CALLOC                                            \
  calloc /**< Default allocator to use, can be undefined */
#define MBEDTLS_PLATFORM_STD_FREE                                              \
  free /**< Default free to use, can be undefined */
// #define MBEDTLS_PLATFORM_STD_EXIT            exit /**< Default exit to use,
// can be undefined */ #define MBEDTLS_PLATFORM_STD_TIME            time /**<
// Default time to use, can be undefined. MBEDTLS_HAVE_TIME must be enabled */
// #define MBEDTLS_PLATFORM_STD_FPRINTF      fprintf /**< Default fprintf to
// use, can be undefined */ #define MBEDTLS_PLATFORM_STD_PRINTF        printf
...
// enabled */ #define MBEDTLS_PLATFORM_TIME_TYPE_MACRO       time_t /**< Default
// time macro to use, can be undefined. MBEDTLS_HAVE_TIME must be enabled */
// #define MBEDTLS_PLATFORM_FPRINTF_MACRO      fprintf /**< Default fprintf
// macro to use, can be undefined */ #define MBEDTLS_PLATFORM_PRINTF_MACRO
...
// #define MBEDTLS_SSL_DEFAULT_TICKET_LIFETIME     86400 /**< Lifetime of
// session tickets (if enabled) */ #define MBEDTLS_PSK_MAX_LEN               32
// /**< Max size of TLS pre-shared keys, in bytes (default 256 bits) */ #define
