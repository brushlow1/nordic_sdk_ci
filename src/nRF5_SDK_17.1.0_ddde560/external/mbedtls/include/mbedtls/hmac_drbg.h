 ...
 * #MBEDTLS_HMAC_DRBG_RESEED_INTERVAL by default. Override this value by calling
 ...
 *                      and also at most
 *                      #MBEDTLS_HMAC_DRBG_MAX_SEED_INPUT - \p entropy_len * 3 /
 * 2 where \p entropy_len is the entropy length described above.
 *
 ...
 */
int mbedtls_hmac_drbg_random_with_add(void *p_rng, unsigned char *output,
                                      size_t output_len,
                                      const unsigned char *additional,
                                      size_t add_len);
...
/**
 * \brief               This function resets HMAC_DRBG context to the state
 * immediately after initial call of mbedtls_hmac_drbg_init().
 *
 ...
 *                      Unused if \p additional is \c NULL.
 */
MBEDTLS_DEPRECATED void
mbedtls_hmac_drbg_update(mbedtls_hmac_drbg_context *ctx,
