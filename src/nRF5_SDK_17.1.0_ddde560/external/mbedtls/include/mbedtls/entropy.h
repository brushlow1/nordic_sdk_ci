...
#define MBEDTLS_ERR_ENTROPY_MAX_SOURCES                                        \
  -0x003E /**< No more sources can be added. */
#define MBEDTLS_ERR_ENTROPY_NO_SOURCES_DEFINED                                 \
  -0x0040 /**< No sources have been added to poll. */
...
#define MBEDTLS_ERR_ENTROPY_FILE_IO_ERROR                                      \
  -0x003F /**< Read/write error in file. */
 ...
 */
typedef int (*mbedtls_entropy_f_source_ptr)(void *data, unsigned char *output,
 ...
 *                      instance. No more than MBEDTLS_ENTROPY_MAX_SEED_SIZE
 * bytes are read from the seed file. The rest is ignored.
 *
 * \param ctx           Entropy context
 * \param path          Name of the file
 *
