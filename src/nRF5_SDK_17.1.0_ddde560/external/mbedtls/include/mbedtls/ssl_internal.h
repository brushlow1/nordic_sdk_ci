...
/* Compression buffer holds both IN and OUT buffers, so should be size of the
 * larger */
...
struct mbedtls_ssl_handshake_params {
  ...
  unsigned int
      async_in_progress : 1; /*!< an asynchronous operation is in progress */
...
mbedtls_ssl_own_key(mbedtls_ssl_context *ssl) {
...
static inline int mbedtls_ssl_safer_memcmp(const void *a, const void *b,
                                           size_t n) {
  size_t i;
