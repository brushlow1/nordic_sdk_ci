...
#error "MBEDTLS_ECP_C defined, but not all prerequisites"
    ...
    !(defined(MBEDTLS_ECP_ALT) || defined(MBEDTLS_CTR_DRBG_C) ||               \
      defined(MBEDTLS_HMAC_DRBG_C) || defined(MBEDTLS_SHA512_C) ||             \
      defined(MBEDTLS_SHA256_C) || defined(MBEDTLS_ECP_NO_INTERNAL_RNG))
#error                                                                         \
    "MBEDTLS_ECP_C requires a DRBG or SHA-2 module unless MBEDTLS_ECP_NO_INTERNAL_RNG is defined or an alternative implementation is used"
#endif
