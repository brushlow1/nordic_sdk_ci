...
#define P(a, b, c, d, e, f, g, h, x, K)                                        \
  ...
  do {
    P(local.A, local.B, local.C, local.D, local.E, local.F, local.G, local.H,
      local.W[i], K[i]);
    i++;
    P(local.H, local.A, local.B, local.C, local.D, local.E, local.F, local.G,
      local.W[i], K[i]);
    i++;
    P(local.G, local.H, local.A, local.B, local.C, local.D, local.E, local.F,
      local.W[i], K[i]);
    i++;
    P(local.F, local.G, local.H, local.A, local.B, local.C, local.D, local.E,
      local.W[i], K[i]);
    i++;
    P(local.E, local.F, local.G, local.H, local.A, local.B, local.C, local.D,
      local.W[i], K[i]);
    i++;
    P(local.D, local.E, local.F, local.G, local.H, local.A, local.B, local.C,
      local.W[i], K[i]);
    i++;
    P(local.C, local.D, local.E, local.F, local.G, local.H, local.A, local.B,
      local.W[i], K[i]);
    i++;
    P(local.B, local.C, local.D, local.E, local.F, local.G, local.H, local.A,
      local.W[i], K[i]);
    i++;
  } while (i < 80);
 ...
 */
int mbedtls_sha512_ret(const unsigned char *input, size_t ilen,
