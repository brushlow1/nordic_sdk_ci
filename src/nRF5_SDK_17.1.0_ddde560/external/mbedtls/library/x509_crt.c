...
static int x509_crt_check_signature(const mbedtls_x509_crt *child,
  ...
  if (rs_ctx != NULL && child->sig_pk == MBEDTLS_PK_ECDSA) {
    return (mbedtls_pk_verify_restartable(
        &parent->pk, child->sig_md, hash, mbedtls_md_get_size(md_info),
  ...
  return (mbedtls_pk_verify_ext(
      ...
      mbedtls_md_get_size(md_info), child->sig.p, child->sig.len));
}
...
static int x509_crt_verify_chain(mbedtls_x509_crt *crt,
  ...
  find_parent:
    ...
    ret = x509_crt_find_parent(child, trust_ca, &parent, &parent_is_trusted,
...
int mbedtls_x509_crt_verify_with_profile(
    ...
    int (*f_vrfy)(void *, mbedtls_x509_crt *, int, uint32_t *), void *p_vrfy) {
  return (mbedtls_x509_crt_verify_restartable(crt, trust_ca, ca_crl, profile,
                                              cn, flags, f_vrfy, p_vrfy, NULL));
}
...
int mbedtls_x509_crt_verify_restartable(
  ...
  *flags = 0;
  ...
  /* Check the chain */
  ret =
      x509_crt_verify_chain(crt, trust_ca, ca_crl, profile, &ver_chain, rs_ctx);
