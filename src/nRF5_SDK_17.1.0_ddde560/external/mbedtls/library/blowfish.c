...
static void blowfish_enc(mbedtls_blowfish_context *ctx, uint32_t *xl,
                         uint32_t *xr) {
  uint32_t Xl, Xr, temp;
  short i;
...
static void blowfish_dec(mbedtls_blowfish_context *ctx, uint32_t *xl,
                         uint32_t *xr) {
  uint32_t Xl, Xr, temp;
  short i;
...
int mbedtls_blowfish_setkey(mbedtls_blowfish_context *ctx,
  ...
  if (keybits < MBEDTLS_BLOWFISH_MIN_KEY_BITS ||
      keybits > MBEDTLS_BLOWFISH_MAX_KEY_BITS || keybits % 8 != 0) {
