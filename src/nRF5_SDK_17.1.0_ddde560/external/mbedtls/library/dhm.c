 ...
 */
static int dhm_read_bignum(mbedtls_mpi *X, unsigned char **p,
 ...
 */
int mbedtls_dhm_read_params(mbedtls_dhm_context *ctx, unsigned char **p,
                            const unsigned char *end) {
  int ret;
 ...
 */
int mbedtls_dhm_set_group(mbedtls_dhm_context *ctx, const mbedtls_mpi *P,
                          const mbedtls_mpi *G) {
  int ret;
  DHM_VALIDATE_RET(ctx != NULL);
...
static int dhm_random_below(mbedtls_mpi *R, const mbedtls_mpi *M,
  ...
  do {
    MBEDTLS_MPI_CHK(
        mbedtls_mpi_fill_random(R, mbedtls_mpi_size(M), f_rng, p_rng));
 ...
 */
int mbedtls_dhm_calc_secret(mbedtls_dhm_context *ctx, unsigned char *output,
...
int mbedtls_dhm_parse_dhm(mbedtls_dhm_context *dhm, const unsigned char *dhmin,
  ...
  if (dhminlen == 0 || dhmin[dhminlen - 1] != '\0')
    ...
    ret = mbedtls_pem_read_buffer(&pem, "-----BEGIN DH PARAMETERS-----",
                                  "-----END DH PARAMETERS-----", dhmin, NULL, 0,
                                  &dhminlen);
