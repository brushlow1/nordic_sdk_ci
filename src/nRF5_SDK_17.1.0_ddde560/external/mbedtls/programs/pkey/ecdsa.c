...
int main(int argc, char *argv[]) {
  ...
  if ((ret = mbedtls_ecdsa_genkey(&ctx_sign, ECPARAMS, mbedtls_ctr_drbg_random,
                                  &ctr_drbg)) != 0) {
  ...
  if ((ret = mbedtls_ecdsa_write_signature(
           &ctx_sign, MBEDTLS_MD_SHA256, hash, sizeof(hash), sig, &sig_len,
  ...
  if ((ret = mbedtls_ecdsa_read_signature(&ctx_verify, hash, sizeof(hash), sig,
                                          sig_len)) != 0) {
