...
#define USAGE3                                                                 \
  ...
  "    reconnect_hard=%%d   default: 0 (disabled)\n" USAGE_TICKETS             \
      USAGE_MAX_FRAG_LEN USAGE_TRUNC_HMAC USAGE_ALPN USAGE_FALLBACK USAGE_EMS  \
          USAGE_ETM USAGE_CURVES USAGE_RECSPLIT USAGE_DHMLEN "\n"
#define USAGE4                                                                 \
...
#if defined(MBEDTLS_CERTS_C)
    ret =
        mbedtls_pk_parse_key(&pkey, (const unsigned char *)mbedtls_test_cli_key,
